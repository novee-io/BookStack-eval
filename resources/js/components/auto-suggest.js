...
export class AutoSuggest extends Component {
    ...
    displaySuggestions(suggestions) {
        ...
        this.list.innerHTML = suggestions.map(value => `<li><div tabindex="0" class="text-item">${value}</div></li>`).join('');
        this.list.style.display = 'block';

        // Ensure any dynamically rendered content scripts are activated
        for (const oldScript of this.list.querySelectorAll('script')) {
